...
/**
 * Varbase extra settings.
 *
 * You can uncomment settings in this file to enable them.
 */
 if (file_exists('./' . conf_path() . '/varbase.settings.inc')) {
   require './' . conf_path() . '/varbase.settings.inc';
 }
 ...
 */
if (file_exists('./' . conf_path() . '/local.settings.inc')) {
  require './' . conf_path() . '/local.settings.inc';
}
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_varbase_7_x_3_7_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_varbase_7_x_3_7_dd.inc';
}
// </DDSETTINGS>
